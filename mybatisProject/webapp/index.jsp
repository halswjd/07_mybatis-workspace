...
<body>
	...
	<!-- 
		* 프레임워크
		- 개발자가 보다 편리한 환경에서 개발할 수 있도록 제공하는 틀, 뼈대라고 생각하면됨
		- 소프트웨어 개발의 입장으로써는 공통적으로 사용되는 라이브러리/개발도구/인터페이스 등등을 의미
		
		* 프레임워크의 필요성
		- 규모가 큰 프로젝트 작업시 많은 개발자들이 필요
		=> 그런 개발자들이 "통일성" 있게 "빠르고" "안정적"으로 개발하기 위해 프레임워크가 좋은 성과를 냄!
		=> 생산성 향상
		
		* 프레임워크 특징
		- 개발자들이 따라야 하는 가이드라인 제공
		=> 자유롭게 설계 / 코딩하는게 아니라 가이드대로 설계하고 코딩하는게 원칙
		- 개발할 수 있는 범위가 정해져 있다
		- 개발자들을 위한 다양한 도구들을 지원
		
		* 프레임워크 장점
		- 개발시간을 줄일 수 있음
		- 유지보수하기에 용이 (너도 나도 다 알아볼 수 있는 코드)
